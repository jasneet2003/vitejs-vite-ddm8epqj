...
import { Play, ExternalLink, MapPin, Phone, Linkedin, Mail, ArrowRight, Instagram, Twitter } from 'lucide-react';
  ...
  const portfolioItems = [
    {
      ...
      videoUrl: 'https://res.cloudinary.com/dkfgg3oqc/video/upload/v1764226628/A_company_called_Blockstream_has_launched_satellites_that_orbit_the_Earth_broadcasting_the_Bitc_grktmf.mp4' 
    },
    {
      id: 2,
      platform: 'Instagram',
      ...
      category: 'Reels',
      videoUrl: 'https://res.cloudinary.com/dkfgg3oqc/video/upload/v1764226993/Who_says_men_don_t_know_about_skincare_From_knowing_the_difference_between_lipstick_color_shades_ht0zfa.mp4'
    },
    {
      id: 3,
      platform: 'Instagram',
      ...
      title: 'Color Grading',
      category: 'Showcase',
      videoUrl: 'https://res.cloudinary.com/dkfgg3oqc/video/upload/v1764227109/Dominant_or_determined_Let_s_talk_about_why_women_s_leadership_is_often_misunderstood.___D_rmo1d1.mp4'
    },
    {
      id: 4,
      platform: 'Twitter',
      ...
      title: 'Twitter Short',
      category: 'Fast Paced',
      videoUrl: 'https://res.cloudinary.com/dkfgg3oqc/video/upload/v1764227247/96EKDFbrNXvo7eBK_olstqf.mp4'
    },
    {
      id: 5,
      platform: 'Instagram',
      ...
      videoUrl: 'https://res.cloudinary.com/dkfgg3oqc/video/upload/v1764226972/Bitcoin_Altcoin_Stablecoin_explained._These_are_the_classification_of_cryptocurrencies_that_h_aic7mp.mp4'
    },
    {
      id: 6,
      platform: 'Instagram',
      ...
      title: 'Dynamic Cuts',
      category: 'Commercial',
      videoUrl: 'https://res.cloudinary.com/dkfgg3oqc/video/upload/v1764226976/get_ecs2it.mp4'
    }
  ];
    ...
    <div className="min-h-screen bg-neutral-950 text-white font-sans selection:bg-blue-500 selection:text-white">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 flex justify-between items-center px-6 py-4 bg-neutral-950/80 backdrop-blur-md border-b border-white/10">
        <div className="flex items-center gap-2">
          <div className="h-8 w-8 bg-blue-600 rounded-lg flex items-center justify-center font-bold">J</div>
          <span className="font-bold text-lg tracking-tight">Jasneet Saini</span>
        </div>
        ...
        <div className="hidden md:flex items-center gap-4 text-xs font-medium uppercase tracking-widest text-neutral-400">
          ...
          <span className="bg-white text-black px-3 py-1 rounded-full font-bold">Edge City</span>
        </div>
      </nav>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-12">
          ...
          <div className="max-w-3xl z-10 relative">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-blue-900/30 border border-blue-500/30 text-blue-400 text-sm font-medium mb-6 animate-fade-in">
              <MapPin size={14} />
              <span>Ready to move anywhere on the globe</span>
            ...
            <p className="text-lg md:text-xl text-neutral-400 max-w-2xl leading-relaxed mb-8">
              I'm Jasneet Singh Saini, a Content Manager specializing in high-retention content for social platforms. 
              Curating frames that stop the scroll.
            </p>

            <div className="flex flex-wrap gap-4">
              <a href="#work" className="flex items-center gap-2 bg-white text-black px-6 py-3 rounded-lg font-bold hover:bg-neutral-200 transition-colors">
                <Play size={18} fill="currentColor" /> View Work
              </a>
              <a href="#contact" className="flex items-center gap-2 border border-white/20 px-6 py-3 rounded-lg font-medium hover:bg-white/5 transition-colors">
                Contact Me
              </a>
            </div>
          </div>
      ...
      <section id="work" className="py-20 px-6 md:px-20 max-w-7xl mx-auto">
        <div className="flex items-end justify-between mb-12 border-b border-white/10 pb-4">
          ...
          <span className="text-neutral-500 text-sm hidden md:block">Hover to preview &middot; Click to view post</span>
        </div>
      ...
      {/* --- CONTACT SECTION --- */}
      <section id="contact" className="py-20 bg-neutral-900 border-t border-white/10">
        <div className="max-w-4xl mx-auto px-6 text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-8">Let's Create Together</h2>
          <p className="text-neutral-400 mb-12">
            I am available immediately for full-time opportunities at 
            <span className="text-white font-bold mx-1">Edge City</span>.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-left">
            ...
            <div className="bg-neutral-950 p-6 rounded-xl border border-white/5 hover:border-blue-500/50 transition-colors group">
              ...
              <h3 className="text-neutral-400 text-sm font-medium mb-1">Phone</h3>
            ...
            <div className="bg-neutral-950 p-6 rounded-xl border border-white/5 hover:border-blue-500/50 transition-colors group">
              ...
              <h3 className="text-neutral-400 text-sm font-medium mb-1">Address</h3>
              <p className="text-lg font-bold text-white leading-tight">22 Vishnupuri Colony Main, Indore, MP 452001</p>
            </div>
            ...
            >
              ...
              <h3 className="text-neutral-400 text-sm font-medium mb-1">LinkedIn</h3>
              <div className="flex items-center gap-2">
      ...
      <footer className="py-8 text-center text-neutral-600 text-sm border-t border-white/5 bg-neutral-950">
        <p>&copy; {new Date().getFullYear()} Jasneet Singh Saini. Created for Edge City.</p>
      </footer>
...
const VideoCard = ({ item }) => {
  ...
  return (
    ...
    >
      ...
      <div className={`absolute inset-0 bg-gradient-to-t from-black via-black/50 to-transparent p-6 flex flex-col justify-end transition-opacity duration-300 ${isPlaying ? 'opacity-0' : 'opacity-100'}`}>
        <div className="flex items-center gap-2 mb-2">
          {item.platform === 'Twitter' ? <Twitter size={14} className="text-blue-400"/> : <Instagram size={14} className="text-pink-500"/>}
          <span className="text-xs font-bold uppercase tracking-wider text-neutral-300">{item.platform}</span>
        </div>
        <h3 className="text-xl font-bold text-white mb-1">{item.title}</h3>
        <p className="text-sm text-neutral-400">{item.category}</p>
      </div>

      <div className={`absolute inset-0 flex items-center justify-center bg-black/20 backdrop-blur-[2px] transition-opacity duration-300 ${isPlaying ? 'opacity-100' : 'opacity-0'}`}>
